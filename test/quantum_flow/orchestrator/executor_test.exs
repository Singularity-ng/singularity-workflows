  ...
  defmodule QuantumFlow.Orchestrator.ExecutorTest do
    ...
    describe "execute_workflow/4" do
      test "executes workflow successfully with monitoring" do
        ...
        Mox.stub(QuantumFlow.Orchestrator.Repository.Mock, :update_execution_status, fn _,
                                                                                        _,
                                                                                        _,
                                                                                        _ ->
      ...
      test "handles execution failure" do
        ...
        {:error, :execution_failed} = Executor.execute_workflow(workflow, context, QuantumFlow.Repo)
      end
      ...
      test "handles execution record creation failure" do
        ...
        {:error, :database_error} = Executor.execute_workflow(workflow, context, QuantumFlow.Repo)
      end
    end
    ...
    describe "execute_task/5" do
      test "executes task successfully" do
        ...
        Mox.stub(QuantumFlow.Orchestrator.Repository.Mock, :update_task_execution_status, fn _,
                                                                                             _,
                                                                                             _,
                                                                                             _ ->
        ...
        {:ok, result} = Executor.execute_task(task_config, context, execution, QuantumFlow.Repo)
      ...
      test "handles task execution failure" do
        ...
        {:error, :task_failed} =
          Executor.execute_task(task_config, context, execution, QuantumFlow.Repo)
      end
    ...
    describe "get_execution_status/2" do
      test "returns execution status and progress" do
        ...
        {:ok, status} = Executor.get_execution_status("exec_123", QuantumFlow.Repo)
      ...
      test "handles execution not found" do
        ...
        {:error, :not_found} = Executor.get_execution_status("nonexistent", QuantumFlow.Repo)
      end
    end
    ...
    describe "cancel_execution/3" do
      test "cancels running execution successfully" do
        ...
        :ok = Executor.cancel_execution("exec_123", QuantumFlow.Repo, reason: "User requested")
      end
      ...
      test "handles execution not found" do
        ...
        {:error, :not_found} = Executor.cancel_execution("nonexistent", QuantumFlow.Repo)
      end
      ...
      test "handles execution not running" do
        ...
        {:error, :execution_not_running} = Executor.cancel_execution("exec_123", QuantumFlow.Repo)
      end
      ...
      test "force cancels non-running execution" do
        ...
        :ok = Executor.cancel_execution("exec_123", QuantumFlow.Repo, force: true)
      end
    end
  end
end
