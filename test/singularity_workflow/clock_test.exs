defmodule Singularity.Workflow.ClockTest do
  use ExUnit.Case, async: false

  alias Singularity.Workflow.{Clock, TestClock}
  ...
  describe "TestClock - integration with Application config" do
    test "Application.get_env returns TestClock in test environment" do
      clock = Application.get_env(:singularity_workflow, :clock)

      assert clock == Singularity.Workflow.TestClock
    end
