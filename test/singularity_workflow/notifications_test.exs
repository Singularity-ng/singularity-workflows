defmodule Singularity.Workflow.NotificationsTest do
  ...
  describe "listen/2" do
    test "starts listening for NOTIFY events with logging" do
      ...
      original_notifications =
        Application.get_env(:singularity_workflow, :notifications_module, Postgrex.Notifications)

      Application.put_env(:singularity_workflow, :notifications_module, MockNotifications)

      on_exit(fn ->
        Application.put_env(:singularity_workflow, :notifications_module, original_notifications)
      end)
    ...
    test "handles listener start failure" do
      ...
      Application.put_env(:singularity_workflow, :notifications_module, FailingNotifications)
  ...
  describe "unlisten/2" do
    ...
    test "handles unlisten failure" do
      ...
      Application.put_env(:singularity_workflow, :notifications_module, FailingUnlisten)
