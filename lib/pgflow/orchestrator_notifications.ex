defmodule Pgflow.OrchestratorNotifications do
  @moduledoc """
  HTDAG-specific notifications for ex_pgflow.
  ...
  ## Example
      ...
      Pgflow.OrchestratorNotifications.broadcast_decomposition(
        "goal-123",
        :started,
  ...
  ## Example
      ...
      Pgflow.OrchestratorNotifications.broadcast_task(
        "task-456",
        :completed,
  ...
  ## Example
      ...
      {:ok, pid} = Pgflow.OrchestratorNotifications.listen(
        "my_workflow",
        MyApp.Repo,
