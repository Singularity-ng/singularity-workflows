defmodule Pgflow.TestWorkflowPrefix do
  @moduledoc """
  ...
  ## Usage
      ...
      # In test setup
      {:ok, prefix} = Pgflow.TestWorkflowPrefix.start()
      ...
      # Clean up after test
      Pgflow.TestWorkflowPrefix.cleanup_by_prefix(prefix, Repo)

  ## Design

  - Each test run gets a unique UUID-based prefix
  - Prefix format: "pgflow_test_<short_uuid>_"
