defmodule QuantumFlow.StepTask do
  @moduledoc """
  ...
  ## Usage
      ...
      %QuantumFlow.StepTask{}
      |> QuantumFlow.StepTask.changeset(%{
        run_id: run.id,
      ...
      # Claim a queued task
      task
      |> QuantumFlow.StepTask.claim(worker_id)
      |> Repo.update()

      # Complete a task
      task
      |> QuantumFlow.StepTask.mark_completed(%{"receipt_id" => "12345"})
      |> Repo.update()
  """
  ...
  schema "workflow_step_tasks" do
    ...
    belongs_to(:step_state, QuantumFlow.StepState,
      define_field: false,
