defmodule QuantumFlow.Orchestrator.ExampleDecomposer do
  @moduledoc """
  ...
  ## Usage
      ...
      {:ok, result} = QuantumFlow.WorkflowComposer.compose_from_goal(
        ...
        &QuantumFlow.Orchestrator.ExampleDecomposer.simple_decompose/1,
        step_functions,
        MyApp.Repo
      )
      ...
      {:ok, result} = QuantumFlow.WorkflowComposer.compose_from_goal(
        ...
        &QuantumFlow.Orchestrator.ExampleDecomposer.microservices_decompose/1,
        step_functions,
        MyApp.Repo
      )
  """
