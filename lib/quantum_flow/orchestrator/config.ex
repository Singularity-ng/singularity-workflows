defmodule QuantumFlow.Orchestrator.Config do
  @moduledoc """
  ...
  ## Example
      ...
      timeout = QuantumFlow.Orchestrator.Config.get([:execution, :timeout])
      
      # Override defaults
      timeout = QuantumFlow.Orchestrator.Config.get(:timeout, timeout: 600_000)
  """
  ...
  defp get_htdag_config do
    Application.get_env(:quantum_flow, :htdag, default_config())
  end
