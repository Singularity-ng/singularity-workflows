defmodule QuantumFlow.Orchestrator.Schemas do
  @moduledoc """
  ...
  defmodule TaskGraph do
    ...
    schema "htdag_task_graphs" do
      ...
      has_many :workflows, QuantumFlow.Orchestrator.Schemas.Workflow, foreign_key: :task_graph_id
  ...
  defmodule TaskExecution do
    ...
    schema "htdag_task_executions" do
      ...
      has_many :events, QuantumFlow.Orchestrator.Schemas.Event, foreign_key: :task_execution_id
