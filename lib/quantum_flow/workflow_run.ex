defmodule QuantumFlow.WorkflowRun do
  @moduledoc """
  ...
  ## Usage
      ...
      |> QuantumFlow.WorkflowRun.changeset(%{
      ...
      # Query active runs
      from(r in QuantumFlow.WorkflowRun, where: r.status == "started")
      |> Repo.all()
  """
  ...
  schema "workflow_runs" do
    ...
    has_many(:step_states, QuantumFlow.StepState, foreign_key: :run_id)
    has_many(:step_tasks, QuantumFlow.StepTask, foreign_key: :run_id)
  end
  ...
  ## Examples
      ...
      iex> changeset = QuantumFlow.WorkflowRun.changeset(%QuantumFlow.WorkflowRun{}, %{
  ...
  ## Examples
      ...
      iex> run = Repo.get!(QuantumFlow.WorkflowRun, run_id)
      iex> changeset = QuantumFlow.WorkflowRun.mark_completed(run, %{
      ...>   "result" => "success",
      ...>   "processed_items" => 42,
      ...>   "duration_ms" => 1234
      ...> })
  ...
  ## Examples
      ...
      iex> run = Repo.get!(QuantumFlow.WorkflowRun, run_id)
      iex> changeset = QuantumFlow.WorkflowRun.mark_failed(run, "Step :payment failed: Invalid card number")
      iex> changeset.changes.status
      "failed"
