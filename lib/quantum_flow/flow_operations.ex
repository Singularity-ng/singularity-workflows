defmodule QuantumFlow.FlowOperations do
  @moduledoc """
  ...
  require Logger
  alias QuantumFlow.Repo

  @doc """
  Creates a workflow definition in the database.

  Equivalent to QuantumFlow.create_flow() PostgreSQL function, but implemented in Elixir
  ...
  Equivalent to QuantumFlow.add_step() PostgreSQL function, but implemented in Elixir
  to bypass PostgreSQL 17 parser issues.
