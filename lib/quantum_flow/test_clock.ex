defmodule QuantumFlow.TestClock do
  @moduledoc """
  ...
  ## Usage
      ...
      # In tests
      time1 = QuantumFlow.TestClock.now()
      # => ~U[2025-01-01 00:00:00.000000Z]

      QuantumFlow.TestClock.advance(5000)  # Advance 5 seconds

      time2 = QuantumFlow.TestClock.now()
      # => ~U[2025-01-01 00:00:05.000000Z]

      # Test timeout behavior
      QuantumFlow.TestClock.advance(60_000)  # Advance 1 minute
  ...
  ## Examples
      ...
      iex> QuantumFlow.TestClock.reset()
      iex> time1 = QuantumFlow.TestClock.now()
      iex> QuantumFlow.TestClock.advance(5000)
      iex> time2 = QuantumFlow.TestClock.now()
      iex> DateTime.diff(time2, time1, :millisecond)
      5000

      # Advance by 1 minute
      iex> QuantumFlow.TestClock.reset()
      iex> QuantumFlow.TestClock.advance(60_000)
      iex> QuantumFlow.TestClock.now()
  ...
  ## Examples
      ...
      iex> QuantumFlow.TestClock.reset(custom_time)
      iex> QuantumFlow.TestClock.now()
