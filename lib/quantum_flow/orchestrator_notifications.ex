defmodule QuantumFlow.OrchestratorNotifications do
  ...
  - **Complements**: QuantumFlow.Orchestrator, QuantumFlow.OrchestratorOptimizer

  ### Call Graph
  - `listen/2` → `QuantumFlow.Notifications` (base notifications)
  - `broadcast_decomposition_event/4` → QuantumFlow.Notifications
  - `broadcast_task_event/4` → QuantumFlow.Notifications
  - `broadcast_workflow_event/4` → QuantumFlow.Notifications
  ...
  defp notifications_impl do
    Application.get_env(:quantum_flow, @notifications_env_key, QuantumFlow.Notifications)
  end
