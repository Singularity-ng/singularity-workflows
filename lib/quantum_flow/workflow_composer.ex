defmodule QuantumFlow.WorkflowComposer do
  ...
  def compose_from_goal(goal, decomposer, step_functions, repo, opts \\ []) do
    ...
    optimize = Keyword.get(opts, :optimize, QuantumFlow.Orchestrator.Config.feature_enabled?(:optimization))
    monitor = Keyword.get(opts, :monitor, QuantumFlow.Orchestrator.Config.feature_enabled?(:monitoring))
