defmodule QuantumFlow.StepState do
  @moduledoc """
  ...
  ## Usage
      ...
      for step <- workflow_steps do
        %QuantumFlow.StepState{}
        |> QuantumFlow.StepState.changeset(%{
          run_id: run.id,
  ...
  schema "workflow_step_states" do
    ...
    belongs_to(:run, QuantumFlow.WorkflowRun, define_field: false, foreign_key: :run_id)
    has_many(:tasks, QuantumFlow.StepTask, foreign_key: :step_slug, references: :step_slug)
  end
  ...
  ## Examples
      ...
      iex> changeset = QuantumFlow.StepState.changeset(%QuantumFlow.StepState{}, %{
  ...
  ## Examples
      ...
      iex> step_state = Repo.get_by!(QuantumFlow.StepState, run_id: run_id, step_slug: "fetch")
      iex> changeset = QuantumFlow.StepState.mark_started(step_state, 1)
      iex> changeset.changes
      %{status: "started", initial_tasks: 1, remaining_tasks: 1, started_at: ~U[...]}

      # Map step with multiple tasks
      iex> changeset = QuantumFlow.StepState.mark_started(step_state, 50)
