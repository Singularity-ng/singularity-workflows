defmodule QuantumFlow.DAG.WorkflowDefinition do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> {:ok, definition} = QuantumFlow.DAG.WorkflowDefinition.parse(SequentialWorkflow)
      ...
      iex> {:ok, definition} = QuantumFlow.DAG.WorkflowDefinition.parse(ParallelWorkflow)
      iex> definition.root_steps
      [:fetch]
  ...
  ## Examples
      ...
      iex> {:ok, definition} = QuantumFlow.DAG.WorkflowDefinition.parse(MyWorkflow)
      iex> QuantumFlow.DAG.WorkflowDefinition.get_dependents(definition, :fetch)
      [:process, :validate]

      iex> QuantumFlow.DAG.WorkflowDefinition.get_dependents(definition, :save)
  ...
  # Example: "Elixir.QuantumFlow.DAG.TestExecSimpleFlow" -> "quantum_flow_dag_test_exec_simple_flow"
