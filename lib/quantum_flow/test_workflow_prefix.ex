defmodule QuantumFlow.TestWorkflowPrefix do
  @moduledoc """
  ...
  ## Usage
      ...
      # In test setup
      {:ok, prefix} = QuantumFlow.TestWorkflowPrefix.start()
      ...
      # Clean up after test
      QuantumFlow.TestWorkflowPrefix.cleanup_by_prefix(prefix, Repo)

  ## Design

  - Each test run gets a unique UUID-based prefix
  - Prefix format: "quantum_flow_test_<short_uuid>_"
  ...
  def start() do
    ...
    "quantum_flow_test_#{short_uuid}_"
  end
