defmodule Singularity.Workflow.Repo.Migrations.MapOobQualifyColumns do
  @moduledoc """
  Qualify OOB UPDATE targets to avoid PL/pgSQL ambiguous run_id vs record fields.
  """
  use Ecto.Migration
  ...
  WHERE st.workflow_slug = p_workflow_slug
    ...
    AND EXISTS (
      ...
      JOIN workflow_step_tasks dep
        ...
        AND jsonb_typeof(dep.output) = 'array'
        AND jsonb_array_length(dep.output) <= st.task_index
...
$$
    ...
    'Claims queued tasks. Map OOB fails+archives excess indexes (qualified UPDATEs).';
    """)
  end
