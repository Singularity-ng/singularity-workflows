defmodule Pgflow.Repo.Migrations.FixAddStepAmbiguousColumns do
  @moduledoc """
  Fixes ambiguous column references in pgflow.add_step() function.

  The validation query for dependencies had ambiguous column references
  where dep_slug appeared in multiple contexts.
  """
  use Ecto.Migration
  ...
  def down do
    # This will be reverted by the previous migration
    :ok
  end
end
