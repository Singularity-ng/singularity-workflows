defmodule Singularity.Workflow.Repo.Migrations.MapOobFailInStartTasksFixed do
  @moduledoc """
  ...
  full-array fallback payload. (Corrected apply of 20260720030400.)

  Consumer: public.start_tasks.
  """
  use Ecto.Migration
